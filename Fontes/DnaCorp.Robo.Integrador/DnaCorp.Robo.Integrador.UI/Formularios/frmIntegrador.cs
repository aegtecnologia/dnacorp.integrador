    ...
    public partial class frmIntegrador : Form
    {
        ...
        private void Executar()
        {
            try
            {
                ...
                texto.AppendLine($"Próxima execução as {query.FirstOrDefault().DataFinal.AddMilliseconds(timer1.Interval).ToString("HH:mm:ss")}");
            ...
            {
                this.Invoke(new AtualizaLogCallBack(this.AtualizaLog), new object[] { erro.Message });
            }
        }
